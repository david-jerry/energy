...
try:
    ...
    ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["etopoenergy.com", "www.etopoenergy.com"])
...
# MEDIA
# ------------------------------------------------------------------------------
DEFAULT_FILE_STORAGE = "etopoenergy.utils.storages.MediaRootS3Boto3Storage"
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Etopo Energy <noreply@etopoenergy.com>",
)
